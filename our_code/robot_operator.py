...
def receive_new_frame(data_frame: DataFrame):
    ...
    if (num_frames % 15 == 0):
        ...
        # Calculate the angle between the chaser and target positions
        ...
        plot_positions(chaser_positions, target_positions)
        #plot_positions_realtime(chaser_positions, target_positions)
...
def plot_positions(chaser_positions, target_positions):
    ...
    chaser_x, chaser_y = chaser_positions[-1]
