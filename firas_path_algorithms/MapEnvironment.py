...
from PARAMETERS import PlaygroundConfig
# 2.71, 0.14, 1.06
...
class MapEnvironment(object):
    ...
    def __init__(self, json_file):
        ...
        self.xlimit = [PlaygroundConfig.X_MIN, PlaygroundConfig.X_MAX + 0.1]
        self.ylimit = [PlaygroundConfig.Y_MIN, PlaygroundConfig.Y_MAX]
